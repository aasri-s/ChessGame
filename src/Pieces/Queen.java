...
/*
* represents the movements and abilities of the queen piece
*/
public class Queen extends Piece{
	public Queen(final Type typeIn, final int positionIn, boolean isWhiteIn) {
		super(typeIn, positionIn, isWhiteIn);
	}
	
	/*
	 * returns a list with all of the moves that the queen may make
	...
	// if a piece is being changed to a queen this method returns the new piece
	// after the change occurs
	@Override
	public Piece changePiece(Moves changingPiece, boolean isWhite) {
		return new Queen(Type.QUEEN, changingPiece.there, isWhite);
	}
}
